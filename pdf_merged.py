...
test = "Ceci est un test pour voir le nouveau fichier git 2"

list_files = os.listdir(
    "fusion/"
)  # on obtient une liste de str contenant l'ensemble des fichier/dossier du répertoire (même des fichier non pdf)
